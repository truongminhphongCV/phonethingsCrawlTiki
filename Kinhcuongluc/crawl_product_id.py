...
headers = {
    ...
    'Referer': 'https://tiki.vn/mieng-dan-man-hinh/c1824',
...
params = {
    ...
    'aggregations': '2',
    'trackity_id': '599cee73-9cc6-38b8-f040-b6ca2a1073b3',
    'category': '1824',
    'page': '1',
    'src': 'c1824',
    'urlKey':  'mieng-dan-man-hinh',
}
...
df.to_csv('product_id_kinhcuongluc.csv', index=False)
